...
class UserWatchlistItem {
    ...
    public function __construct(string $id, string $id_user, string $id_production, float $mark, string $date_added, string $review, bool $is_planned, string $date_modified) {
        $this->id = $id;
    ...
    public function isIsPlanned(): bool {
